...
import com.prisma.entity.msisdnaccount.model.TbMsisdnaccountMongo;
...
// @Repository
@RepositoryRestResource(collectionResourceRel = "msisdnaccountmongo", path = "msisdnaccountmongo")
public interface MsisdnaccountMongoRepository extends MongoRepository<TbMsisdnaccountMongo, String> {
